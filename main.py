...
# conv1 = Mconvolution(data, kernel_size = 5, output_num = 20)
# pool1 = Mmax_pooling(conv1, kernel_size = 2, stride = 2)
# conv2 = Mconvolution(pool1, kernel_size = 5, output_num = 50)
# pool2 = Mmax_pooling(conv2, kernel_size = 2, stride = 2)
# flat1 = Mflatten(pool2)
# fc1 = Mfull_connection(flat1, 500)
# relu1 = Mrelu(fc1)
# fc2 = Mfull_connection(relu1, 10)
# softmax = Msoftmax(fc2)
